...
def generate_launch_description():
    ...
    # Start urg_node2 as a lifecycle node
    ...
    # Transition from Unconfigured to Inactive state (performed when auto_start is true)
    ...
    # Transition from Inactive to Active state (performed when auto_start is true)
    ...
    # About parameters
    # auto_start: Automatically transition to Active state when starting (default: true)
    # node_name: Node name (default: "urg_node2")
    # scan_topic_name: Topic name (default: "scan") *Multi-echo not supported*    
